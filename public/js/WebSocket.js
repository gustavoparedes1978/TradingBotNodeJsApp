...
function startWebSocket(socket,streamName)
{
    ...
    socket.onmessage = function(event) 
    {
        ...
        if(currentDate>currentCloseTime)
        {
            ...
            {
                buyOrderOpenMin = currentPrice + lowestATR*0.0625;
                buyOrderOpenMax = currentPrice + lowestATR*0.06375;
                buyOrderClose = currentPrice + lowestATR*0.125;
                ...
                sellOrderOpenMin = currentPrice - lowestATR*0.0625;
                sellOrderOpenMax = currentPrice - lowestATR*0.06375;
                sellOrderClose = currentPrice - lowestATR*0.125;
